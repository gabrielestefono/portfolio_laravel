  ...
  "nodes": [
    {
      ...
      "data": {
        "label": "Frontend",
        "description": "Desenvolvimento Frontend é a prática de converter dados em uma interface gráfica, através do uso de HTML, CSS e JavaScript, para que os usuários possam visualizar e interagir com esses dados.",
        "type": "start",
        "completed": false,
        "links": [
          {
    ...
    },
    {
      ...
      "data": {
        "label": "HTML",
        "description": "HTML (HyperText Markup Language) é a linguagem de marcação padrão para documentos projetados para serem exibidos em um navegador da web.",
        "type": "skill",
        "completed": false,
        "links": [
          {
    ...
    },
    {
      ...
      "data": {
        "label": "CSS",
        "description": "CSS (Cascading Style Sheets) é uma linguagem de estilo usada para descrever a apresentação de um documento escrito em HTML ou XML.",
        "type": "skill",
        "completed": false,
        "links": [
          {
